...
let sidebarFilterItem = document.querySelectorAll(".sidebar__filter-item")
let sidebarFilterTitle = document.querySelectorAll(".sidebar__filter-title-wrapper")
...
sidebarFilterTitle.forEach(item=>{
    item.addEventListener("click" , event=>{
        event.currentTarget.nextElementSibling.classList.toggle("accordion--active")
    })
})